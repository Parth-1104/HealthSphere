  ...
  return docInfo &&(
    <div>
      ...
      <div className=' flex flex-col sm:flex-row gap-4'>
        <div>
          <img className='bg-blue-500 w-full sm:max-w-72 rounded-lg mix-blend-multiply' src={docInfo.image} alt="" />
        </div>
        ...
        <div >
          ...
          <p className='text-sm text-gray-500 max-w-[700px] mx-1'>{docInfo.about}</p>
        </div>
