...
const Navbar = () => {
    ...
    const getNavLinkClass = ({ isActive }) =>
        ...
        } before:absolute before:bottom-0 before:left-0 before:w-full before:h-0.5 before:bg-white before:origin-right before:scale-x-0 before:transition-transform before:duration-300 ${
    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
            scrolled 
                ? 'py-2 bg-gradient-to-br from-indigo-600 to-violet-800 shadow-lg' 
                ...
                <div className="flex items-center gap-x-4">
                    {token && userData ? (
                        ...
                        <div className="relative group">
                            <button className="flex items-center gap-3 cursor-pointer bg-white/10 backdrop-blur-sm rounded-full py-1 px-3 hover:bg-white/20 transition-colors border border-white/20">
                                ...
                                <img 
                                    className="w-3 transition-transform duration-300 group-hover:rotate-180 brightness-0 invert" 
                            ...
                            <div className="absolute top-full right-0 mt-2 w-56 bg-white rounded-lg shadow-lg py-1 overflow-hidden transition-all duration-200 transform origin-top-right scale-95 opacity-0 invisible group-hover:scale-100 group-hover:opacity-100 group-hover:visible border border-gray-200">
                                <div className="bg-gradient-to-r from-indigo-100 to-violet-100 px-4 py-3">
                        ...
                        <button
                            ...
                            className="hidden md:flex items-center gap-2 bg-white text-indigo-700 px-6 py-2.5 rounded-full font-medium hover:bg-indigo-50 transition-all duration-300 shadow-md"
                        >
                    ...
                    <button
                        ...
                        className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-white/20 transition-colors lg:hidden"
                    >
            ...
            <div className={`fixed inset-0 z-50 ${showMenu ? 'block' : 'hidden'}`}>
                ...
                <div className={`absolute top-0 right-0 h-full w-80 bg-white shadow-xl transform transition-transform duration-300 ease-in-out ${
                    ...
                    <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-indigo-600 to-violet-800">
                    ...
                    <div className="p-5">
                        ...
                        {!token && (
                            <div className="mt-8">
                                <button
                                    ...
                                    className="w-full bg-gradient-to-r from-indigo-600 to-violet-800 text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 flex items-center justify-center gap-2"
                                >
                                    <span>Login / Sign Up</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        {token && userData && (
                            <div className="mt-8 bg-gradient-to-r from-indigo-50 to-violet-50 p-4 rounded-lg border border-indigo-100">
                                ...
                                <div className="space-y-2">
                                    <button
                                        ...
                                        className="w-full bg-white text-indigo-700 px-4 py-2 rounded-lg border border-indigo-100 flex items-center gap-2 hover:bg-indigo-50 transition-colors"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-red-50 text-red-600 px-4 py-2 rounded-lg border border-red-100 flex items-center gap-2 hover:bg-red-100 transition-colors"
                                    >
                                        <span>Logout</span>
                                    </button>
                                </div>
